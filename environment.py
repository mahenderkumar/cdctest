...
def login_application(context):
    ...
    try:
        sleep(2)
        # WebDriverWait(context.driver, 10).until(lambda driver: context.driver.find_element_by_id("id_state").is_displayed())
        sleep(7)
        Select(context.driver.find_element_by_id("id_state")).select_by_visible_text("Delhi NCR")
        # WebDriverWait(context.driver, 10).until(lambda driver: context.driver.find_element_by_id("id_city").is_displayed())
        Select(context.driver.find_element_by_id("id_city")).select_by_visible_text("Gautam Buddh Nagar")
        # WebDriverWait(context.driver, 10).until(lambda driver: context.driver.find_element_by_id("id_institute").is_displayed())
        sleep(3)
        Select(context.driver.find_element_by_id("id_institute")).select_by_visible_text(collegeName)
        context.driver.find_element_by_id("exampleInputEmail1").send_keys("12345")
...
def admin_user_login(context):
    ...
    WebDriverWait(context.driver, 10).until(lambda driver: context.driver.find_element_by_xpath(".//*[@id='id_username']").is_displayed())
...
def new_college_user(context):
    ...
    try:
        ...
        # WebDriverWait(context.driver, 10).until(lambda driver: context.driver.find_element_by_id("id_city").is_displayed())
        Select(context.driver.find_element_by_id("id_city")).select_by_visible_text("Gautam Buddh Nagar")
        context.driver.find_element_by_xpath(".//*[@id='exampleInputEmail1']").send_keys(collegeName)
        context.driver.find_element_by_xpath(".//*[@id='id_register_form']/ul/li[4]/div/div/input").send_keys("12345")
